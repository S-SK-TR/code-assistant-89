...
- `CLAUDE.md` dosyasındaki `CodeAssistant - AI Kod Yardımcısı`, `CodeAssistant - AI Kod Yardımcısı — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
